...
def run_sweep(A, config=None):
    with wandb.init(config=config):
        ...
        A_grit = GRIT(grit_data, ts_data,config,np.array(A))
        A_grit_error = np.linalg.norm(A - A_grit, ord="fro")
        """END GRIT"""
        
        wandb.log({"A_appex": A_est, "H_appex": H_est, "A_grit": A_grit, "A_errors": A_errors, "H_errors": H_errors, "A_appex_final_error": A_final_error, "H_appex_final_error": H_final_error, "A_grit_final_error": A_grit_error, "A": A})
